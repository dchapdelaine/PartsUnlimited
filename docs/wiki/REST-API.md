...
## Zip
   The Zip API allows downloading folders as zip files, or expanding zip files into folders. Not recommended for deployments, see [Zip Deployment](https://github.com/projectkudu/kudu/wiki/REST-API#zip-deployment-preview).
...
## Zip Deployment
See [[Deploying from a zip file]] for details.
